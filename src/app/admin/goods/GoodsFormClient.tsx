  ...
  return (
    ...
    >
      <Form.Item
        ...
        name="code"
        rules={
          shouldValidateGoodsCode(mode)
            ? [
                { required: true, message: '请输入商品编码' },
                {
                  pattern: GOODS_CODE_PATTERN,
      ...
      >
        <Input placeholder="如：G000001" disabled={mode === 'edit'} maxLength={7} />
      </Form.Item>
      ...
      <Space style={{ width: '100%' }} size="large">
        <Form.Item label="规格" name="spec" style={{ width: 250 }} tooltip="如：500g、1kg、500ml">
